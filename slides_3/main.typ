...
#figure(image("../assets/img/2024_10_10_klassen_datentypen_initial_rev01.png", height: 40%), caption: [Initialwerte von Objektvariablen])
]
...
#figure(image("../assets/img/2024_10_10_klassen_referenz_zuweisung_rev01.png"), caption: [Zuweisung von Referenzen an Variablen])
...
#align(left + horizon)[
  #figure(image("../assets/img/2024_10_10_klassen_referenzen_verschieben_rev01.png"), caption: [Verschieben von Referenzen])
]
...
#slide[
  ...
  #figure(image("../assets/img/2024_10_14_referenzen_selbes_objekt_rev01.png"), caption: [Beide Variablen zeigen zur gleichen Referenz])

]

#slide[
- Das Objekt, was vorher über `jan` referenziert wurde, hat nun keine Referenz mehr.
...
- Es gibt kein `free` oder `delete` wie in C!
  ...
  #figure(image("../assets/img/2024_10_14_referenz_objekt_verschwindet_rev01.png"), caption: [Der Garbage Collector gibt Speicher frei])
]
...
#slide[
  #align(left + horizon)[
    #figure(image("../assets/img/2024_10_14_methoden_callbyvalue_rev01.png"), caption: [Diagramm für Call-by-Value])
  ]
]
...
#figure(image("../assets/img/2024_10_14_referenz_lena_objekt_rev01.png"), caption: [Ausgangszustand])
]
...
#figure(image("../assets/img/2024_10_14_referenz_lena_student_verschieben_rev01.png"), caption: [Verschieben der Referenz in die Methode])
]
...
#figure(image("../assets/img/2024_10_14_referenz_lena_student_birgit_rev01.png"), caption: [Änderung des Objekts in Methode])
]
...
#figure(image("../assets/img/2024_10_14_this_diagramm_rev01.png", height: 40%), caption: [`this`-Referenz])
]
...
#slide[
#task[Schreiben Sie eine weitere Methode in der selben Klasse, die das Maximum zweier `double`-Zahlen berechnet.]
...
#slide[
#task[Schreiben Sie noch eine weitere Methode in der selben Klasse, die das Maximum von drei Integerzahlen zurückgibt.]
...
#slide[
  ...
  #tip[Über die Menüpunkte Code / Generate / Getter and Setter können Sie sich weitere Zeit sparen!]
]
...
#slide[
  ...
  #figure(image("../assets/img/2024_10_14_objekt_circle_rev01.png", height: 40%), caption: [Speicher wird für jedes Objekt erneut reserviert.])
]
...
#slide[
  ...
  #figure(image("../assets/img/2024_10_15_circle_count_rev01.png", height: 40%), caption: [Die Variable `count` wird immer wieder neu gemacht.])
]
...
#slide[
  #figure(image("../assets/img/2024_10_15_klassenattribute_rev01.png"), caption: [Klassenattribute in den verschiedenen Objekten])
]
