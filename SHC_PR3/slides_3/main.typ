...
#import "@preview/fletcher:0.5.8" as flechter: diagram, node, edge
...
#slide[
  ...
  #figure(
    image(
      "../assets/img/2024_10_10_klassen_methoden_attribute_rev01.png", height: 45%,
    ), caption: [Aufteilung Methoden und Attribute],
  )
]
...
#figure(
  image("../assets/img/2024_10_10_klassen_mehr_objekte_rev01.png", height: 60%), caption: [Mehrere Objekte aus einer Klasse],
)
...
#figure(
  image("../assets/img/2024_10_10_klassen_uml_student_rev01.png"), caption: [UML-Darstellung der Klasse, die wir eben erstellt haben],
)
...
#figure(
  image("../assets/img/2024_10_10_klassen_mehr_objekte_uml_rev01.png"), caption: [Aus einer Klasse lassen sich mehrere Objekte erstellen],
)
...
#figure(
  image(
    "../assets/img/2024_10_10_klassen_primitiv_erklaerung_rev01.png", height: 50%,
...
- Schritt 1: `new`-Operator erzeugt Objekt.
  ...
  #figure(
    image("../assets/img/2024_10_10_klassen_primitv_vergleich.png"), caption: [Erstellen von Referenz mit `new`],
  )
...
- Schritt 2: Zuweisung
  ...
  #figure(
    image("../assets/img/2024_10_10_klassen_primitiv_zuordnung_rev01.png"), caption: [Zuweisung von Referenz an Variable],
  )
]
...
#slide[
  ...
  #figure(
    image(
      "../assets/img/2024_10_10_klassen_datentypen_initial_rev01.png", height: 40%,
...
#figure(
  image("../assets/img/2024_10_10_klassen_referenz_zuweisung_rev01.png"), caption: [Zuweisung von Referenzen an Variablen],
)
...
#align(
  ...
  #figure(
    image("../assets/img/2024_10_10_klassen_referenzen_verschieben_rev01.png"), caption: [Verschieben von Referenzen],
  )
]
...
#figure(
  image("../assets/img/2024_10_14_referenzen_selbes_objekt_rev01.png"), caption: [Beide Variablen zeigen zur gleichen Referenz],
)
...
- Es gibt kein `free` oder `delete` wie in C!
  ...
  #figure(
    image("../assets/img/2024_10_14_referenz_objekt_verschwindet_rev01.png"), caption: [Der Garbage Collector gibt Speicher frei],
  )
]
...
#slide[
  #align(
    ...
    #figure(
      image("../assets/img/2024_10_14_methoden_callbyvalue_rev01.png"), caption: [Diagramm für Call-by-Value],
    )
  ]
]

== Methoden: Objekte als Parameter
...
#figure(
  image("../assets/img/2024_10_14_referenz_lena_objekt_rev01.png"), caption: [Ausgangszustand],
)
]
...
#figure(
  image("../assets/img/2024_10_14_referenz_lena_student_verschieben_rev01.png"), caption: [Verschieben der Referenz in die Methode],
)
]
...
#figure(
  image("../assets/img/2024_10_14_referenz_lena_student_birgit_rev01.png"), caption: [Änderung des Objekts in Methode],
)
]
...
#figure(
  image("../assets/img/2024_10_14_this_diagramm_rev01.png", height: 40%), caption: [`this`-Referenz],
)
]
...
#text(size: 18pt)[
#align(left + horizon)[
#grid(gutter: 12pt, columns: (auto, auto), [
```java
int max(int a, int b) {
    if (a > b) {
        return a;
...
#slide[
  ...
  #figure(
    image("../assets/img/2024_10_14_objekt_circle_rev01.png", height: 40%), caption: [Speicher wird für jedes Objekt erneut reserviert.],
  )
]
...
#figure(
  image("../assets/img/2024_10_15_circle_count_rev01.png", height: 40%), caption: [Die Variable `count` wird immer wieder neu gemacht.],
)
]
...
#slide[
  #figure(
    image("../assets/img/2024_10_15_klassenattribute_rev01.png"), caption: [Klassenattribute in den verschiedenen Objekten],
  )
]
