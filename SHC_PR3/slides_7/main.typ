...
#figure(image("../assets/img/2024_10_25_window_frame_aufbau_rev01.png", height: 50%), caption: [Aufbau eines Frames])
  ]
]
...
#figure(image("../assets/img/2024_10_25_window_frame_hierarchie_rev01.png", height: 70%), caption: [Hierarchie eines Windows])
  ]
]
...
- Und es sieht nicht wirklich schön aus:
  ...
  - Das Fenster „klebt“ in der linken oberen Ecke!      
    ...
    #grid(columns: (60%, 40%), gutter: 0.25em, left, right)
...
#figure(image("../assets/img/2024_10_29_observer_interface_rev01.png", height: 50%), caption: [Interface `Oberserver`])
  ]
]
